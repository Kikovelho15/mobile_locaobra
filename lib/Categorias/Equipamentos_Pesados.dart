...
class EquipamentosPesadosPage extends StatelessWidget {
  const EquipamentosPesadosPage({super.key});

  // Nome desta categoria, usado no breadcrumb e para destacar a aba certa
  // na linha de navegação.
  static const String _categoriaAtual = 'Equipamentos Pesados';
