...
class AndaimesEEscadasPage extends StatelessWidget {
  const AndaimesEEscadasPage({super.key});

  // Nome desta categoria, usado no breadcrumb e para destacar a aba certa
  // na linha de navegação.
  static const String _categoriaAtual = 'Andaimes e Escadas';
  ...
  static const List<Produto> _produtos = [
    Produto(
      ...
      descricao: 'Guinchos de Coluna 350kg Aplicação',
      precoPorDia: 35.00,
    ),
  ];
